...
public class Sale {
    ...
    public Sale(int entryID, String saleID, int productID, String dateOfSale,
        ...
        this.dateOfSaleString = dateOfSale;
        this.dateOfSale = convertDateStringToDate();
    ...
    private Date convertDateStringToDate(){
        ...
        try {
            java.util.Date date = format.parse(dateOfSaleString);
